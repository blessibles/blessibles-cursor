...
export default function ProductsPage() {
  ...
  const recommendations = useMemo(() => {
    ...
    // If no search, show the first 3 products (no randomization to avoid hydration errors)
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
        <h1 className="text-2xl font-bold text-blue-900 mb-6">Browse Products</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {mounted &&
            filteredResults.map((product) => (
              <div
                key={product.id}
                className="bg-white border border-blue-100 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow relative block"
              ...
              >
                <div className="absolute top-2 right-2 z-10 flex gap-2">
                  ...
                  <button
                    ...
                    onClick={e => { e.preventDefault(); toggleCollection(product.id); }}
